                ...
                <div className="w-full surface-card py-5 px-5 sm:px-5" style={{ borderRadius: '20px' }}>
                    <div className="flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        <div className="flex justify-content-center align-items-center bg-pink-500 border-circle" style={{ height: '3.2rem', width: '3.2rem' }}>
                            <i className="pi pi-fw pi-key text-2xl text-white"></i>
                        </div>
                        <h1 className="text-900 font-bold text-5xl mb-2">Authentication</h1>
                        ...
                        <div>
                            ...
                            <Button label="Sign In" className="w-full p-3 text-md" onClick={handleLogin} />
                        </div>
                    </div>
                </div>
            </div>
